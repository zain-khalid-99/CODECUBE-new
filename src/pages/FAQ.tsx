      ...
      <main className="flex-grow pt-32 pb-20 px-6 relative overflow-hidden">
        ...
        <div className="container max-w-4xl mx-auto">
          ...
          <div className="space-y-4">
            {faqs.map((faq, index) => (
              <motion.div
                ...
                className="glass rounded-none overflow-hidden border border-white/5"
              >
                <button
                ...
                >
                  ...
                  <div className="bg-primary/10 p-2 rounded-none text-primary">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="mt-20 p-12 glass rounded-none text-center border-primary/20 bg-primary/5"
          >
            ...
            <a 
              href="/contact" 
              className="inline-flex h-14 items-center justify-center px-10 bg-primary text-white rounded-none font-bold shadow-strong-glow hover:scale-105 transition-transform"
            >
