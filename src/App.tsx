...
const PageLoader = () => (
  <div className="fixed inset-0 flex items-center justify-center bg-background z-[100]">
    <motion.div
      ...
      className="w-12 h-12 bg-primary rounded-xl shadow-strong-glow"
    />
  </div>
);
  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location}>
        ...
        <Route path="/work" element={<Suspense fallback={<PageLoader />}><PageWrapper><OurWork /></PageWrapper></Suspense>} />
