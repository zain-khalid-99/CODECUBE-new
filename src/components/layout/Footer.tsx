          ...
          <div className="flex flex-wrap justify-center gap-4">
            {socialLinks.map((social) => (
              <a
                ...
                className="w-12 h-12 rounded-none border border-white/10 bg-white/5 flex items-center justify-center text-text-secondary hover:text-white hover:bg-white/10 hover:border-primary/50 hover:scale-105 transition-all duration-200 group"
              >
